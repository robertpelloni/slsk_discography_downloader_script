# Roadmap
- [x] Phase 1: Core functionality - stable downloading, searching, and gap filling.
- [x] Phase 2: Rust Bridge Integration - Real Soulseek protocol implementation in Rust Search Bridge.
...
- [ ] Phase 8: Cross-platform packaging and distribution - Automated multi-platform Docker builds and release artifacts.
